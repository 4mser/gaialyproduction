<div>
    <x-modal openModal="{{ $openModal }}">
        ...
        {{-- <img class="image-form"
            src="http://media.istockphoto.com/vectors/image-preview-icon-picture-placeholder-for-website-or-uiux-design-vector-id1222357475?b=1&k=20&m=1222357475&s=170667a&w=0&h=S4rQXn5gFTcmcZJSBOxKr1ufmasJRLUX5dcBhBB6V-A="
            alt="image"> --}}
    ...
    <x-modal-component showModal="{{ $openForm }}" title="{{ $title }}">
        <div class="grid place-items-center col-span-2">
            <img class="w-[36rem] h-[36rem]"
                src="http://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Red_X.svg/2048px-Red_X.svg.png"
                alt="image" />
        </div>
        <form class="text-xs" wire:submit.prevent="save">
