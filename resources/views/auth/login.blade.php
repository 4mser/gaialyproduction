            ...
            <div class="mt-5 flex flex-col gap-4">
                ...
                <div class="text-sm">
                    <a href="{{ route('login.google') }}" class="my-2 flex items-center justify-center space-x-2 rounded bg-gray-100 py-2 text-gray-600 hover:bg-gray-200">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 326667 333333" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
                    ...
                    <a href="{{ route('login.linkedin') }}" class="my-2 flex items-center justify-center space-x-2 rounded bg-gray-100 py-2 text-gray-600 hover:bg-gray-200">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.31">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill: #0a66c2;
