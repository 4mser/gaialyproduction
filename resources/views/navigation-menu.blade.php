<div class="sidebar fixed absolute inset-y-0 left-0 z-20 w-48 -translate-x-full transform bg-white transition duration-200 ease-in-out md:relative md:w-48 md:translate-x-0">
