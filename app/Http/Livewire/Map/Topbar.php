...
class Topbar extends Component
{
    ...
    public function render()
    {
        ...
        $companyOptions = ['' => __('All companies')] + Company::getOptions()->toArray();


        $operations = Operation::join('companies', 'companies.id', '=', 'companies.id')
        ...
        if ($this->authUser->isUserProfile()) {
        ...
        return view('livewire.map.topbar', [
    ...
    public function delete($operationId)
    {
        ...
        try {
            ...
            $this->dispatchBrowserEvent('toast', [
                'type' => 'error',
                'message' => __('Error when trying to delete the inspection.')
            ]);
        }
    }
